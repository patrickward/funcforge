...
func TestAttrClass(t *testing.T) {
	...
	for _, tt := range tests {
		result := attr.FuncMap()["attrClass"].(func(...any) template.HTMLAttr)(tt.pairs.([]any)...)
...
func TestSafeAttr(t *testing.T) {
	...
	for _, tt := range tests {
		result := attr.FuncMap()["attrSafe"].(func(string) template.HTMLAttr)(tt.input)
		assert.Equal(t, tt.expected, result)
	}
}
...
func TestSelectedAttr(t *testing.T) {
	...
	for _, tt := range tests {
		result := attr.FuncMap()["attrSelected"].(func(any, string) template.HTMLAttr)(tt.current, tt.value)
		assert.Equal(t, tt.expected, result)
	}
}
...
func TestCheckedAttr(t *testing.T) {
	...
	for _, tt := range tests {
		result := attr.FuncMap()["attrChecked"].(func(any, string) template.HTMLAttr)(tt.current, tt.value)
		assert.Equal(t, tt.expected, result)
	}
}
...
func TestDisabledAttr(t *testing.T) {
	...
	for _, tt := range tests {
		result := attr.FuncMap()["attrDisabled"].(func(any, string) template.HTMLAttr)(tt.current, tt.value)
		assert.Equal(t, tt.expected, result)
	}
}
...
func TestReadonlyAttr(t *testing.T) {
	...
	for _, tt := range tests {
		result := attr.FuncMap()["attrReadonly"].(func(any, string) template.HTMLAttr)(tt.current, tt.value)
		assert.Equal(t, tt.expected, result)
	}
}
