...
func FuncMap() template.FuncMap {
	return template.FuncMap{
		"slcChunk":   Chunk,   // Was: "group"
		"slcFilter":  Filter,  // Filter slice by predicate
		"slcGroup":   Group,   // Was: N/A"
		"slcHas":     Has,     // Was: "has"
		"slcNew":     New,     // Was: "slice" - Creates new slice
		"slcReverse": Reverse, // Reverse sort a slice
		"slcSort":    Sort,    // Sort any slice
		"slcUnique":  Unique,  // Get unique elements
