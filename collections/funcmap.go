...
func FuncMap() template.FuncMap {
	return template.FuncMap{
		"colFirst":    first,    // Get the first element of a collection
		"colLast":     last,     // Get the last element of a collection
		"colNth":      nth,      // Get the nth element of a collection
		"colJoin":     fmtJoin,  // Join collection elements with separator
		"colList":     fmtList,  // Format collection as a list
		"colEmpty":    isEmpty,  // Check if collection is empty
		"colSize":     size,     // Get collection size
		"colContains": contains, // Check if collection contains value
	}
}
