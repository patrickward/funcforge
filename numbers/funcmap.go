...
func FuncMap() template.FuncMap {
	return template.FuncMap{
		"numAdd":      add,                // Add two integers
		"numCents":    cents,              // Format a number as currency with cents
		"numCurrency": currency,           // Format a number as currency
		"numDecr":     decrement,          // Decrement a number by 1
		"numFormat":   format,             // Format any number with commas and decimals
		"numIncr":     increment,          // Increment a number by 1
		"numMod":      mod,                // Get the remainder of a division
		"numPercent":  percentage,         // Format a number as a percentage
		"numSci":      scientificNotation, // Format a number in scientific notation
		"numSub":      subtract,           // Subtract two integers
	}
}
