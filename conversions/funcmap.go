...
func FuncMap() template.FuncMap {
	return template.FuncMap{
		"toNumber": toNumber, // Convert any type to a number
		"toFloat":  toFloat,  // Convert any type to a float
		"toInt":    toInt,    // Convert any type to an integer
		"toString": toString, // Convert any type to a string
	}
}
