...
import (
	...
	hopURL "github.com/patrickward/funcforge/url"
)
...
func TestUrlSetParam(t *testing.T) {
	...
	for _, tt := range tests {
		...
		result := hopURL.FuncMap()["urlSet"].(func(string, any, *url.URL) *url.URL)(tt.key, tt.value, u)
...
func TestUrlDelParam(t *testing.T) {
	...
	for _, tt := range tests {
		u, _ := url.Parse(tt.urlStr)
		result := hopURL.FuncMap()["urlDel"].(func(string, *url.URL) *url.URL)(tt.key, u)
		assert.Equal(t, tt.expected, result.String())
	}
}
...
func TestUrlToAttr(t *testing.T) {
	...
	for _, tt := range tests {
		u, _ := url.Parse(tt.urlStr)
		result := hopURL.FuncMap()["urlToAttr"].(func(*url.URL) template.HTMLAttr)(u)
...
func TestUrlEscape(t *testing.T) {
	...
	for _, tt := range tests {
		result := hopURL.FuncMap()["urlEscape"].(func(string) string)(tt.input)
		assert.Equal(t, tt.expected, result)
	}
}
