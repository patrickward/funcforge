...
import (
	...
	forgeTime "github.com/patrickward/funcforge/time"
)
...
func TestTimeAgo(t *testing.T) {
	...
	for _, tt := range tests {
		result := forgeTime.FuncMap()["timeAgo"].(func(time.Time) string)(tt.input)
...
func TestFormatTime(t *testing.T) {
	...
	for _, tt := range tests {
		result := forgeTime.FuncMap()["timeFormat"].(func(string, time.Time) string)(tt.format, tt.input)
		assert.Equal(t, tt.expected, result)
	}
}
...
func TestIsToday(t *testing.T) {
	...
	for _, tt := range tests {
		result := forgeTime.FuncMap()["timeIsToday"].(func(time.Time) bool)(tt.input)
		assert.Equal(t, tt.expected, result)
	}
}

func TestTimeNow(t *testing.T) {
	result := forgeTime.FuncMap()["timeNow"].(func() time.Time)()
...
func TestTimeSince(t *testing.T) {
	...
	result := forgeTime.FuncMap()["timeSince"].(func(time.Time) time.Duration)(start)
...
func TestTimeUntil(t *testing.T) {
	...
	result := forgeTime.FuncMap()["timeUntil"].(func(time.Time) time.Duration)(future)
	assert.WithinDuration(t, now, now.Add(result), time.Hour+time.Second)
}
